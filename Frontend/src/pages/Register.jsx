    ...
    <div className="flex">
      <div className="flex flex-col items-center justify-center w-full p-8 md:w-1/2 md:p-12">
        ...
        className="w-full max-w-md p-8 bg-white border rounded-lg shadow-sm">
          ...
          <button type="submit" className="w-full p-2 font-semibold text-white bg-black rounded-lg hover:bg-gray-800">
            Register
          </button>
      ...
      <div className=" w-1/2 bg-gray-800 hidden md:block">
        <div className="flex flex-col items-center justify-center h-full">
            <img src={register} alt="Log in to Account"
