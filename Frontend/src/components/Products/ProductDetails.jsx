...
const ProductDetails = () => {
    ...
    return (
    <div className="py-6">
        <div className="mx-auto bg-white rounded-lg max-w-6xl p-8">
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 md:ml-10">
                   ...
                   <p className="line-through mb-1 text-lg text-gray-600">${selectedProduct.originalPrice}</p>
                    ...
                    <div className="flex gap-2 mt-2">
                        {
                            selectedProduct.sizes.map((size) => (
                                <button key={size} className={`px-4 py-2 border rounded ${selectedSize=== size ? "bg-black text-white ": ""}`}
